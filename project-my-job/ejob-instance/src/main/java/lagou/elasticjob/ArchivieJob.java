package lagou.elasticjob;

import com.dangdang.ddframe.job.api.ShardingContext;
import com.dangdang.ddframe.job.api.simple.SimpleJob;
import elasticjob.JdbcUtil;
...
public class ArchivieJob implements SimpleJob {
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        List<Map<String, Object>> list = elasticjob.JdbcUtil.executeQuery(selectSql);
        ...
        elasticjob.JdbcUtil.executeUpdate(updateSql,id);
